...
public class NoteDetailsActivity extends AppCompatActivity {
    ...
    ImageButton saveNoteBtn, deleteNoteBtn, backBtn;
        ...
        documentReference.set(note).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                    Utility.showToast(NoteDetailsActivity.this,"Successfully Added!");
                    finish();
                } else {
                    Utility.showToast(NoteDetailsActivity.this,"Please Try Again!");
                }
            }
        });
    }
    void deleteNoteFromFirebase() {
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                    Utility.showToast(NoteDetailsActivity.this,"Successfully Deleted!");
                    finish();
                } else {
                    Utility.showToast(NoteDetailsActivity.this,"Please Try Again!");
                }
